...
min_disallowable_year_of_birth = 1989
max_disallowable_year_of_birth = 2001
years_of_experience_for_exception = 3


response = year_of_birth < min_disallowable_year_of_birth and \
          year_of_birth > max_disallowable_year_of_birth or \
